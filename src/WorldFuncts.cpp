...
void World::initialize(){
    ...
    if (!buildingTexture.loadFromFile("/Users/corinnejones/VideoGame/art/Building.png"))
    {
    exit(0);
    }
    else
    ...
    if (!candyCollectTexture.loadFromFile("/Users/corinnejones/VideoGame/art/Yum.png"))
    {
        exit(0);
    }
    else
...
void World::initializeCandy(){
    ...
    if (!candyTexture.loadFromFile("/Users/corinnejones/VideoGame/art/Candy.png"))
    {
    exit(0);
    }
    else
